...
public interface IArgumentValue extends IValue {
     ...
     * returned depending of the type of the {@link IArgumentValue}
     * concrete type:
     *    <ul>
     *     <li> {@link AnnotationValue} => {@link Annotation} </li>
     *     <li> {@link ObjectValue}  => {@link Map}<{@link String}, {@link IArgumentValue}> </li>
     *     <li> {@link ArrayValue} => {@link List}<{@link IArgumentValue}> </li>
