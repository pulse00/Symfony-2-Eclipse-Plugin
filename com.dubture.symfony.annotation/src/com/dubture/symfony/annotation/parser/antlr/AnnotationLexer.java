// $ANTLR 3.3 Nov 30, 2010 12:45:30 AnnotationLexer.g 2011-10-25 00:39:56
...
public class AnnotationLexer extends Lexer {
            ...
            switch (alt6) {
                case 1 :
                    ...
                    do {
                        ...
                        if ( (LA4_0==' '||(LA4_0>=',' && LA4_0<=':')||(LA4_0>='A' && LA4_0<='Z')||LA4_0=='\\'||LA4_0=='_'||(LA4_0>='a' && LA4_0<='}')) ) {
                            alt4=1;
                        }
                ...
                case 2 :
                    ...
                    do {
                        ...
                        if ( (LA5_0==' '||(LA5_0>=',' && LA5_0<=':')||(LA5_0>='A' && LA5_0<='Z')||LA5_0=='\\'||LA5_0=='_'||(LA5_0>='a' && LA5_0<='}')) ) {
                            alt5=1;
                        }
    ...
    public final void mNONCONTROL_CHAR() throws RecognitionException {
        try {
            ...
            // AnnotationLexer.g:
            {
            if ( input.LA(1)==' '||(input.LA(1)>=',' && input.LA(1)<=':')||(input.LA(1)>='A' && input.LA(1)<='Z')||input.LA(1)=='\\'||input.LA(1)=='_'||(input.LA(1)>='a' && input.LA(1)<='}') ) {
                input.consume();
