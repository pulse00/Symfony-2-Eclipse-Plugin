...
public class AnnotationArgumentValueNodeVisitor extends AbstractAnnotationNodeVisitor {
    ...
    protected ArgumentValue visitArrayValue(AnnotationCommonTree arrayValueNode) {
    ...
    protected ArgumentValue visitObjectValue(AnnotationCommonTree objectValueNode) {
    ...
    protected ArgumentValue visitAnnotationValue(AnnotationCommonTree annotationValueNode) {
